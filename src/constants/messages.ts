export const BOT_MESSAGES = {
  SUCCESS: {
    ...
    WEEKLY_SCHEDULE_CREATED: (count: number, total: number) => `✅ Đã tạo ${count}/${total} tasks vào Calendar!`,
  },
  ERRORS: {
  ...
  PROMPTS: {
    ...
    INJECTING_SCHEDULE: '⏳ Đang đẩy lịch trình vào Calendar...',
  ...
  BUTTONS: {
    ...
    APPROVE_SCHEDULE: '🟢 Duyệt & Lên lịch Calendar',
